          ...
          {items.length === 0 ? (
            ...
            <ul className="space-y-4">
              {items.map((item) => {
                ...
                return (
                  <li key={item.key} className="flex gap-3 rounded-2xl border border-ink-950/5 p-3">
                    ...
                    <div className="flex flex-1 flex-col">
                      ...
                      {variant && <span className="text-xs text-ink-950/45">{variant}</span>}
                      <div className="mt-1 flex items-center justify-between">
                        ...
                        <span className="font-display font-bold text-ink-950">{formatPrice(item.unitPrice * item.quantity)}</span>
                      </div>
                    </div>
                  </li>
                );
